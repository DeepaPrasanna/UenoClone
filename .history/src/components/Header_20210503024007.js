      ...
      <Navbar expand="md">
        ...
        <Navbar.Collapse id="basic-navbar-nav ">
          <Nav className="ml-auto d-none d-sm-none d-md-flex m-2 p-3">
            <Nav.Link href="#home" className = "px-3">Services</Nav.Link>
            <Nav.Link href="#link" className = "px-3">Clients</Nav.Link>
            <Nav.Link href="#link" className = "px-3">Careers</Nav.Link>
